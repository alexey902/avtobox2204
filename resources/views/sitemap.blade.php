...
<head>
	...
	<!-- Document Title
        ============================================= -->
	<title>Avtobox - карта сайта</title>
</head>
<body>
<!-- Document Wrapper
	============================================= -->
...
============================================= -->
	<section id="widgets">
		<div class="container">
			<div class="row">
				<div class="col-xs-12  col-sm-12  col-md-8 sidebar mb-30-xs mb-30-sm">
					...
					<div class="widget widget-categories">
						...
						<div class="widget-content">
							<ul class="list-unstyled">
								<li>
									<a href="{{url('/home-1')}}"><i class="fa fa-angle-double-right"></i><span>Главная страница сайта:</span><br>http://avtobox.net/home-1</a>
								</li>
								<li>
									<a href="{{url('/shop-1')}}"><i class="fa fa-angle-double-right"></i><span>Страница выбора товаров по производителю автомобиля:</span><br>http://avtobox.net/shop</a>
								</li>
								<li>
									<a href="{{url('shop1/armrests')}}"><i class="fa fa-angle-double-right"></i><span>Страница выбора подлокотника:</span><br>http://avtobox.net/shop1/armrests</a>
								</li>
								<li>
									<a href="{{url('/shop1/armrests/all/1')}}"><i class="fa fa-angle-double-right"></i><span>Описание и фотографии модели подлокотоника:</span><br>http://avtobox.net/shop1/armrests/all/</a>
								</li>
								<li>
									<a href="{{url('/shop1/armrests/model/1')}}"><i class="fa fa-angle-double-right"></i><span>Выбор модели транспортного средства:</span><br>http://avtobox.net//shop1/armrests/model/1</a>
								</li>
								<li>
									<a href="{{url('/contacts')}}"><i class="fa fa-angle-double-right"></i><span>Страница обратного звонка:</span><br>http://avtobox.net/contacts</a>
								</li>

								<li>
									<a href="{{url('/contact-3')}}"><i class="fa fa-angle-double-right"></i><span>Страница запроса необходимой запчасти:</span><br>http://avtobox.net/contact-3</a>
								</li>
								<li>
									<a href="{{url('/about')}}"><i class="fa fa-angle-double-right"></i><span>О компании avtobox.net</span><br>http://avtobox.net/about</a>
								</li>
								<li>
									<a href="{{url('/agreement')}}"><i class="fa fa-angle-double-right"></i><span>Соглашение об обработке персональных данных:</span><br>http://avtobox.net/agreement</a>
								</li>
								<li>
									<a href="{{url('/regulations')}}"><i class="fa fa-angle-double-right"></i><span>Положение об обработке персональных данных:</span><br>http://avtobox.net/regulations</a>
								</li>
								<li>
									<a href="{{url('/delivery')}}"><i class="fa fa-angle-double-right"></i><span>Информация о доставке товаров:</span><br>http://avtobox.net//delivery</a>
								</li>
							</ul>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6 col-md-6 footer-widget-link">
						...
						<div class="footer-widget-content">
							<ul class="list-unstyled">
								<li>
									<a href="{{url('/agreement')}}">Положение на обработку персональных данных</a>
								</li>
								<li>
