		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-6">
					<h1>{{$manufacturername[0]->car_manufacturer_name}}</h1>
				</div>
				<!-- .col-md-6 end -->
				<div class="col-xs-12 col-sm-12 col-md-6">
					...
					<div class="widget widget-tags">
						...
						<div class="widget-content">
							@for($i = 0; $i < count($pictures); $i++)
								<a href="{{url('/shop1/armrests/all/'.$pictures[$i]->car_id)}}">{{$pictures[$i]->model}}</a>
							@endfor
						</div>
					</div>
					<!-- .widget-tags end -->
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<div class="product-num pull-left pull-none-xs">
								<h3>Всего <span class="color-theme">{{count($pictures)}}</span> моделей</h3>
							</div>
							<!-- .product-num end -->
							{{--Sort products--}}
							<!-- .product-options end -->
							...
							<div class="col-xs-12 col-sm-6 col-md-4 product">
								<div class="product-img">
									...
									<div class="product-hover">
										<div class="product-action">
											...
											<a class="btn btn-primary" href="{{url('/shop1/armrests/all/'.$pictures[$j]->car_id )}}">Описание</a>
										</div>
									</div>
									<!-- .product-overlay end -->
								</div>
								...
								<div class="product-bio">
									<div class="prodcut-cat">
										<a href="{{url('/shop1/armrests/all/'.$pictures[$j]->car_id)}}">{{$pictures[$j]->model}}</a>
									</div>
									<!-- .product-cat end -->
